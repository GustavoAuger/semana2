...
INSERT INTO especificaciones (
    created_at, updated_at, deleted_at, oferta_id, numero_vacantes, 
...
(NOW(), NOW(), NULL, 1, 2, 0, 'Tiempo completo', 'Remoto', 'Desarrollo', 'Backend', 'Tecnología', 'Senior', 'Tecnología', '5+ años', 'Full-time', 'Universitario'),
(NOW(), NOW(), NULL, 2, 1, 0, 'Tiempo completo', 'Híbrido', 'Diseño', 'UX/UI', 'Tecnología', 'Semi-senior', 'Diseño', '3+ años', 'Full-time', 'Universitario'),
(NOW(), NOW(), NULL, 3, 1, 3, 'Tiempo completo', 'Híbrido', 'Producto', 'Gestión', 'Tecnología', 'Senior', 'Producto', '5+ años', 'Full-time', 'Universitario');
